...
# 2. box width: see PrjLabEquiBFW\style.css for body width, set width to bodywidth - 225
if (knitr::is_latex_output()) {
...
if(!is.null(spt_file_current)) {
  ...
  total_area <- (800 * 7) / 2
  if (st_file_wno_suffix == 'BFW-Equilibrium-Gender-LFP-and-Wage-Code-Companion') {
    text_shared_preamble_one <- paste0("> Go back to [BFW 2022 Code Companion](https://fanwangecon.github.io/PrjLabEquiBFW/) home page or the [MEconTools](https://fanwangecon.github.io/MEconTools/) Toolbox.")
  } else {
    text_shared_preamble_one <- paste0(st_head_link, " Go back to [NSW 2020 Code Companion](https://fanwangecon.github.io/PrjLabEquiBFW/) home page or the [MEconTools](https://fanwangecon.github.io/MEconTools/) Toolbox.")
  }
}
