...
core:
- code: '[bfw_mp_func_demand()](https://github.com/FanWangEcon/PrjLabEquiBFW/blob/main/PrjLabEquiBFW/solvedemand/bfw_mp_func_demand.m)

    '
  package: PrjLabEquiBFW
date: '2022-02-12'
date_start: '2022-02-12'
description: 'This function solves optimal choices in Constant Elasticity of Substitution
  problems with constant returns and two inputs in each sub-nest.
  ...
  Works for CES problems with up to four nest layers, and allows for uneven branches,
  so that some branches go up to four layers, but others have less layers.
...
title: Solving Nested CES Demand Problems (CRS)
titleshort: Solving Nested CES Demand Problems (CRS)
urlcolor: blue
---
