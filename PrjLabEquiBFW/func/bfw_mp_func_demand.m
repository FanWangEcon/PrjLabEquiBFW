...
%   BFW_MP_FUNC_DEMAND generates a container map with key CES demand-side
%   equation for a particular sub-nest.
%
%   MP_FUNC_DEMAND = BFW_MP_FUNC_DEMAND() get default parameters
%
%   MP_FUNC_DEMAND = BFW_MP_FUNC_DEMAND(BL_VERBOSE) prints details
%
%   See also BFWX_MP_FUNC_DEMAND, BFW_MP_FUNC_SUPPLY
%
